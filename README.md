...
Sistema de reportes hecho con la biblioteca jasperreports.

**Requitos para desarrollo del proyecto**

- Java SE JDK 8
- Eclipse IDE Version: 2019-09
- Cualquier gestor de preferencia, para base de datos sqlite(recomendado: DB Browser for sqlite)
- Plugin jasperreports studio para eclipse o app independiente